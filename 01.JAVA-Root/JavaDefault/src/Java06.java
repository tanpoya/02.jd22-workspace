...
public class Java06 {
    public static void main(String[] args) {
        ...
        System.out.println("9000원짜리 점심을 6명이서 먹었다..." + j06.myThird(9000, 6));

        // 나의 네번째 메서드 : 이달의 표어
        System.out.println("이달의 표어:" + j06.makeTitle(1000, "소시지를 드립니다", 1));
        // 이름이 같은 오버로딩 메서드 호출
        ...
        public String makeTitle(int month, String evt, int people) {
            return month + "월의" + evt + "이벤트 담청자는 " + people + "명입니다";
        }
